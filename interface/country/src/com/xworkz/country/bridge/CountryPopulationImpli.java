...
public class CountryPopulationImpli implements CountryPopulation{
    ...
    public boolean tourism(CountryTourism countryTourism) {
        if (countryTourism.touristPrice >= 5000) {
