package com.xworkz.products.internal;
...
public class Suresh {
    ...
    public Suresh(int age,char gender,Laptop laptop,Mouse mouse,Keyboard key)
    {
        this.age=age;
        this.gender=gender;
        this.laptop=laptop;
    ...
    public void displaySuresh()
    {
        System.out.println("Suresh age :"+age+ ","+ "Suresh gender :"+gender);
